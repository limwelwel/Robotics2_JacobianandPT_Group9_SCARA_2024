...
SCARA_Standard.plot(traj4.q,limits = [x1, x2, y1, y2, z1, z2],)
SCARA_Standard.plot(traj5.q,limits = [x1, x2, y1, y2, z1, z2],)
SCARA_Standard.plot(traj6.q,limits = [x1, x2, y1, y2, z1, z2],)
SCARA_Standard.plot(traj7.q,limits = [x1, x2, y1, y2, z1, z2],)
SCARA_Standard.plot(traj8.q,limits = [x1, x2, y1, y2, z1, z2],)
SCARA_Standard.plot(traj9.q,limits = [x1, x2, y1, y2, z1, z2],block= True)
